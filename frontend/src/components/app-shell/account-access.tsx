...
export function AccountAccess() {
  ...
  return <section className="wallet-empty" aria-live="polite">
    ...
    <div>
      ...
      {address && isOnBradbury && <><h2>Wallet connected.</h2><p>{shortenAddress(address)} is connected to Bradbury Testnet. Your read-only contract overview appears below.</p></>}
